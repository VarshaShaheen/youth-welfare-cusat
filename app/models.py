...
class Director(models.Model):
    ...
    biodata = models.FileField(upload_to='director/portfolio',null=True, blank=True)
    duties_and_responsibilities = models.FileField(upload_to='director/portfolio',null=True, blank=True)
